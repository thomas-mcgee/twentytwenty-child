...
function my_theme_enqueue_styles() {
	...
	wp_enqueue_script( 'functions-child', get_stylesheet_directory_uri() . '/js/functions-child-min.js', array( 'jquery' ), $theme->parent()->get('Version') );
	...
	wp_enqueue_style( 'simplelightbox-styles', get_stylesheet_directory_uri() . '/js/simplelightbox/dist/simple-lightbox.min.css',
		array( $parenthandle ),
